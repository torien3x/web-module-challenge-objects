...
let foodOrder = createMenuItem("burrito", 4, "Mexican")
console.log(foodOrder.name, foodOrder.price, foodOrder.category);
...
let newMenuItem = createMenuItem("burger", 14, "Lunch")
console.log(newMenuItem.name, newMenuItem.price, newMenuItem.category);
newMenuItem = createMenuItem("fries", 5, "side")
console.log(newMenuItem.name, newMenuItem.price, newMenuItem.category);
newMenuItem = createMenuItem("Spaghetti", 17, "Dinner")
console.log(newMenuItem.name, newMenuItem.price, newMenuItem.category);
...
let reynaFeedback = reviews[reviews.length - 1];
reynaFeedback.feedback = "this place is chill with really cool people, great for getting work done on weekdays"
...
function addReview(arr, name, rating, feedback) {
  ...
  let newArr = [...arr, newReview]

  return newArr
}

let foodReviews = addReview(reviews, 'Billy', 2, 'Lame Food')
console.log('newReview', foodReviews);
...
let feedBackReview = getReviewByIndex(reviews, 0);
console.log(feedBackReview);
...
let lastReview = getLastReview(reviews);
